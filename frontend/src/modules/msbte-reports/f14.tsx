...
function Format14Content({ examCenter }: { examCenter: any }) {
  ...
  const examCenterName = examCenter?.name || '_____________________________________________________';
  ...
  return (
    <div className="space-y-2 text-[10pt] leading-tight">
      ...
      <div className="space-y-0.5">
        ...
        <p className="text-sm text-neutral-500">Officer-in-charge / Controller of Examination center</p>
      </div>
      ...
      <div className="space-y-0.5 pt-1.5">
        <div className="flex items-center gap-1">
          <span className="text-sm font-medium whitespace-nowrap">Name of the Examination Center / Institute</span>
          <span className="h-5 flex-1 border-b-0 border-black px-1">{examCenterName}</span>
        </div>
        <div className="flex items-center gap-1">
          <span className="text-sm font-medium whitespace-nowrap">Code number of the Center / Institute</span>
      ...
      <div className="space-y-0.5">
        ...
        <p className="text-justify text-sm">
          ...
          examination of{' '}
          <span className="h-5 w-48 border-b-0 border-black px-1">Diploma / Post-Diploma / Post-Graduate Diploma</span>
      ...
      <div className="space-y-1 text-justify text-sm">
        ...
        <p className="leading-tight">
          Maharashtra State Board of Technical Education (Board), Mumbai routinely holds Diploma / Post-Diploma /
          Post-Graduate Diploma examinations in the state. These examinations this time have commenced from
          ...
          (Year). The Board has duly appointed this Institute as examination center and me as the Officer-in-charge of
          the examination center.
        </p>
        <p className="leading-tight">
          Following examinee in this examination has committed a crime. The related information is as under:
        </p>
      </div>
      ...
      <div className="space-y-0.5 border-t-2 border-black pt-1.5">
        <div className="flex items-center gap-1">
          <span className="text-sm font-medium whitespace-nowrap">1. Alleged examinee&apos;s name</span>
        ...
        <div className="flex items-center gap-1">
          <span className="text-sm font-medium whitespace-nowrap">3. Alleged examinee&apos;s Institute name</span>
          <span className="h-5 flex-1 border-b-0 border-black px-1">
        ...
        <div className="flex items-center gap-1">
          <span className="text-sm font-medium whitespace-nowrap">5. Nature of the crime committed</span>
          <span className="h-5 flex-1 border-b-0 border-black px-1">__________________________________</span>
        </div>
        <div className="flex items-center gap-1">
          <span className="text-sm font-medium whitespace-nowrap">6. Name of the subject</span>
          <span className="h-5 flex-1 border-b-0 border-black px-1">___________________________________</span>
        ...
        <div className="flex items-start gap-1">
          <span className="text-sm font-medium whitespace-nowrap">9. Additional information regarding the crime</span>
          <div className="h-5 flex-1 border-b-0 border-black px-1">
            ______________________________________________________________________________________
          </div>
        </div>
      ...
      <div className="space-y-0.5 text-justify text-sm">
        <p className="leading-tight">
          Shri/Smt. <span className="h-5 w-40 border-b-0 border-black px-1">__________________________________</span>
          (examinee&apos;s name) has committed a crime as per section (7) of The Maharashtra Prevention of Malpractices
          at University, Board and other specified Examinations Act, 1982 and this is the legal complaint for the same.
        </p>
      </div>
      ...
      <div className="mt-1 space-y-0.5 border-t-2 border-black pt-1.5">
        ...
        <div className="flex justify-end">
          <div className="w-56">
            ...
            <p className="mt-0.5 text-center text-[8pt]">(Officer-in-charge / controller of examination)</p>
          </div>
        </div>
        <div className="flex items-center gap-1">
          <span className="text-sm font-medium whitespace-nowrap">
        ...
        <div className="flex items-center gap-1">
          <span className="text-sm font-medium whitespace-nowrap">Name of the examination center</span>
          <span className="h-5 flex-1 border-b-0 border-black px-1">{examCenterName}</span>
        </div>
        <div className="flex items-center gap-1">
          <span className="text-sm font-medium whitespace-nowrap">Date:</span>
      ...
      <div className="mt-1 border-t-2 border-dashed border-neutral-300 pt-1 text-[8pt] leading-tight text-neutral-500">
        <p>
          Note: This complaint should be registered with the local police station immediately after detection of
          malpractice and a copy should be submitted to the Board.
        </p>
      </div>
    </div>
  );
